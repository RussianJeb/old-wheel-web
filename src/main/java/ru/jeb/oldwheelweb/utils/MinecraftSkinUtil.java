package ru.jeb.oldwheelweb.utils;
...
public class MinecraftSkinUtil {
    ...
    public static SkinTexture getPlayerSkin(URL skinUrl, boolean slim) {
        try {
            BufferedImage skinImage = ImageIO.read(skinUrl);
            if (skinImage != null) {
                return new SkinTexture(skinImage, slim, false);
            }
        } catch (Exception e) {
            LOGGER.log(Level.FINE, "Failed to read skin image", e);
        }

        return null;
    }

    public static SkinTexture getPlayerSkin(Skin skin, boolean slim) {
        return getPlayerSkin(skin.getContent(), slim);
    }

    public static SkinTexture getPlayerSkin(final byte[] content, boolean slim) {
        try {
            BufferedImage skinImage = ImageIO.read(new ByteArrayInputStream(content));
            if (skinImage != null) {
                return new SkinTexture(skinImage, slim, false);
            }
        } catch (Exception e) {
    ...
    public static SkinTexture getPlayerSkin(Skin skin) {
        return getPlayerSkin(skin, false);
    }

    public static SkinTexture getPlayerSkin(URL skinUrl) {
        return getPlayerSkin(skinUrl, false);
    }

    public static SkinImage getPlayerSkinFront(URL skinUrl, int size) {
        return getPlayerSkinPosition(skinUrl, DefaultSkinPosition.FRONT, size);
    }

    public static SkinImage getPlayerSkinBack(URL skinUrl, int size) {
        return getPlayerSkinPosition(skinUrl, DefaultSkinPosition.BACK, size);
    }

    public static SkinImage getPlayerSkinFront(Skin skin, int size) {
        return getPlayerSkinPosition(skin, DefaultSkinPosition.FRONT, size);
    }

    public static SkinImage getPlayerSkimBack(Skin skin, int size) {
        return getPlayerSkinPosition(skin, DefaultSkinPosition.BACK, size);
    }


    public static SkinImage getPlayerSkinPosition(URL profile, SkinPosition position, int size) throws IllegalArgumentException {
        validateSize(size);
    ...
    public static SkinImage getPlayerSkinPosition(Skin skinEntity, SkinPosition position, int size) throws IllegalArgumentException {
        validateSize(size);

        SkinTexture skin = getPlayerSkin(skinEntity);
